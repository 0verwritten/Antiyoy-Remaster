...
// Hand-drawn "remaster" building sprites, packed into a separate atlas hosted
// alongside atlas.png. Trimmed + fit into square frames by
// devtools/gen-buildings.mjs (run it to regenerate after changing the source
// PNGs in assets/buildings/source/).
export const BUILDINGS_ATLAS_URL = "https://cdn.jsdelivr.net/gh/0verwritten/Antiyoy-Remaster@master/assets/web/buildings.png";

// >>> BUILDINGS (generated by devtools/gen-buildings.mjs) >>>
export const BUILDINGS: Record<string, SpriteRect> = {
  town_house: { x: 0, y: 0, w: 128, h: 128 },
  town_castle: { x: 129, y: 0, w: 128, h: 128 },
  tower_day: { x: 258, y: 0, w: 128, h: 128 },
  strong_tower_day: { x: 0, y: 129, w: 128, h: 128 },
  tower_night: { x: 129, y: 129, w: 128, h: 128 },
  strong_tower_night: { x: 258, y: 129, w: 128, h: 128 },
};
// <<< BUILDINGS <<<
